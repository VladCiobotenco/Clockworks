...
public final class BlueA2 extends AutonomousOpMode {
    ...
    protected TrajectorySequence trajectorySequence() {
        ...
        // Goes to the detected team prop, then to the pixel stack on C1.
        switch (propLocation) {
            case DOWN:
        ...
        // Goes to the team prop's respective location on the backdrop by moving through column C,
        // until row 2, then going downwards until column B.
